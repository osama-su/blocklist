      ...
      <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
        <table class="min-w-full divide-y divide-gray-300">
          ...
          <tbody class="divide-y divide-gray-200">
           @foreach($registeredCompanies as $company)
            <tr>
                ...
                <td class="relative whitespace-nowrap py-4 pr-4 text-right text-sm font-medium">
                    <a href="{{route('registered-companies.show', $company->id)}}" class="text-indigo-600 hover:text-indigo-900">View</a>
                    <a href="{{route('registered-companies.destroy', $company->id)}}" class="text-indigo-600 hover:text-indigo-900">Delete</a>
                </td>
                    </td>
